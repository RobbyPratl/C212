    ...
    public static void main(String[] args) {
        ...
        String[][] scientists = { { "Dr. Mae Jemison", "1956", "astronautics, engineering, and medicine",
                ...
                { "Dr. Percy Julian", "1899",
                        ...
                        "Julian was an accomplished chemist who made many significant contributions to the field of organic chemistry. He synthesized important medicinal compounds, including a drug used to treat glaucoma, and also developed a way to extract chemicals from soybeans, leading to the development of steroid medications." },
                { "Dr. Neil deGrasse Tyson", "1958", "astrophysics, astronomy, and science communication",
                        "Tyson is a renowned astrophysicist who has made significant contributions to the study of galaxies, stars, and black holes. He is also a prolific science communicator who has hosted numerous television shows and written several popular books about space and science." },
                { "Dr. Patricia Bath", "1942", "ophthalmology, laser technology, and health disparities",
                        "Bath was an ophthalmologist who invented a device for removing cataracts using lasers, making the procedure more precise and less invasive. She was also a passionate advocate for health equity and worked to improve access to eye care for underserved communities." } };

        String[][] result = findScientist(scientists, name, byear, field);
        for (int i = 0; i < result.length; i++) {
            if (result[i][0] != null) {
                System.out.println("Name: " + result[i][0]);
                System.out.println("Birth year: " + result[i][1]);
                System.out.println("Field: " + result[i][2]);
                System.out.println("Contribution: " + scientists[i][3]);
                System.out.println();
            }
        }
        input.close();
